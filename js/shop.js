...
function showError(errorId = null) {
	...
	const errorList = {
			generalError:
				"Ocurrió un error al procesar su pedido. Por favor actualice la página e intente de nuevo",
			checkoutError:
				"Ocurrió un error al hacer el checkout de su pedido. Por favor actualice la página e intente de nuevo",
			orderError:
				"Ocurrió un error al enviar su pedido al servidor. Por favor actualice la página e intente de nuevo",
			cartError:
				"Ocurrió un error al adicionar un producto al carrito. Por favor actualice la página e intente de nuevo",
		},
		errorMessage =
